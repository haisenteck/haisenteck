...
Gps_nm gps_settings = {
    .uart_esp_channel = FuriHalSerialIdUsart,
    .uart_nmea_channel = FuriHalSerialIdUsart,
    .uart_general_channel = FuriHalSerialIdUsart,
};
...
static void subghz_gps_uart_on_irq_cb(FuriHalSerialHandle* handle, FuriHalSerialRxEvent event, void* context) {
    UNUSED(handle);
...
SubGhzGPS* subghz_gps_init() {
    ...
    furi_hal_serial_async_rx_start(subghz_gps->serial_handle, subghz_gps_uart_on_irq_cb, subghz_gps, false);

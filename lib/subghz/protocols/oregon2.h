...
typedef struct subghz_protocol_decoder_oregon2 subghz_protocol_decoder_oregon2;
typedef struct subghz_protocol_encoder_oregon2 subghz_protocol_encoder_oregon2;

extern const SubGhzProtocolDecoder subghz_protocol_oregon2_decoder;
extern const SubGhzProtocolEncoder subghz_protocol_oregon2_encoder;
extern const SubGhzProtocol subghz_protocol_oregon2;

/**
 * Allocate subghz_protocol_decoder_oregon2.
 * @param environment Pointer to a SubGhzEnvironment instance
 * @return subghz_protocol_decoder_oregon2* pointer to a subghz_protocol_decoder_oregon2 instance
 */
void* subghz_protocol_decoder_oregon2_alloc(SubGhzEnvironment* environment);

/**
 * Free subghz_protocol_decoder_oregon2.
 * @param context Pointer to a subghz_protocol_decoder_oregon2 instance
 */
void subghz_protocol_decoder_oregon2_free(void* context);

/**
 * Reset decoder subghz_protocol_decoder_oregon2.
 * @param context Pointer to a subghz_protocol_decoder_oregon2 instance
 */
...
/**
 * Serialize data subghz_protocol_decoder_oregon2.
 * @param context Pointer to a subghz_protocol_decoder_oregon2 instance
...
/**
 * Deserialize data subghz_protocol_decoder_oregon2.
 * @param context Pointer to a subghz_protocol_decoder_oregon2 instance
 * @param flipper_format Pointer to a FlipperFormat instance
 * @return status
 */
